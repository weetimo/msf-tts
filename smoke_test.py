#!/usr/bin/env python3
"""Quick smoke test: polyglot-lion-0.6b on 5 nsc-singlish samples (streaming)."""
import os
...
# Load 5 samples via streaming (avoids full 900MB download)
...
print("Loading polyglot-lion-0.6b-v1.5 (transformers backend)...")
